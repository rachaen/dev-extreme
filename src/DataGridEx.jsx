  ...
  return (
    <div>
      ...
      >
        ...
        <Column dataField='Task_ID' width={80} />
        <Column caption='Start Date' dataField='Task_Start_Date' dataType='date' />
        <Column
          caption='Assigned To'
          ...
          allowSorting={false}
        />
        <Column caption='Subject' dataField='Task_Subject' width={350} />
        <Column caption='Status' dataField='Task_Status' />
      </DataGrid>
